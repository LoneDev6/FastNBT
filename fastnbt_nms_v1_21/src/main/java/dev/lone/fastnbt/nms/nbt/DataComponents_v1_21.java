...
import static dev.lone.fastnbt.nms.nbt.CraftItemStack_v1_21.castToCraftItemStack;
import static dev.lone.fastnbt.nms.nbt.CraftItemStack_v1_21.getHandle;

@Implementation.CyclicDependency(type = IDataComponents.class, version = Version.v1_21)
@SuppressWarnings({"unused"})
public class DataComponents_v1_21 implements IDataComponents
{
    @Override
