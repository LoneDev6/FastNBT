...
@Implementation.CyclicDependency(type = ICompoundTag.class, version = Version.v1_21)
@SuppressWarnings({"unchecked", "unused"})
public class CompoundTag_v1_21 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
