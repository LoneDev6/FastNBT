...
public class DataComponents_v1_21_5 implements IDataComponents
{
    ...
    public boolean copyAttributeModifiers(ItemStack bukkitItemStackSource, ItemStack bukkitItemStackDestination)
    {
        ...
        CraftItemStack b = CraftItemStack_v1_21_5.castToCraftItemStack(bukkitItemStackSource);
        ItemAttributeModifiers modifiersB = CraftItemStack_v1_21_5.getHandle(b).get(DataComponents.ATTRIBUTE_MODIFIERS);
        if(modifiersB != null)
        {
    ...
    public boolean copyLore(ItemStack bukkitItemStackSource, ItemStack bukkitItemStackDestination)
    {
        CraftItemStack a = CraftItemStack_v1_21_5.castToCraftItemStack(bukkitItemStackSource);
        CraftItemStack b = CraftItemStack_v1_21_5.castToCraftItemStack(bukkitItemStackSource);
        CraftItemStack_v1_21_5.getHandle(b).set(DataComponents.LORE, CraftItemStack_v1_21_5.getHandle(a).get(DataComponents.LORE));
        return true;
    }
