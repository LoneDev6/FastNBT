...
@Implementation.CyclicDependency(type = INBTStreamTools.class, version = Version.v1_20_R3)
@SuppressWarnings({"unused"})
public class NBTStreamTools_v1_20_R3 implements INBTStreamTools<CompoundTag>
{
    @Override
