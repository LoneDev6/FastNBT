...
@Implementation.CyclicDependency(type = ICompound.class, version = Version.v1_20_R3)
@SuppressWarnings({"unchecked", "unused"})
public class Compound_v1_20_R3 implements ICompound<CompoundTag, ListTag, CompoundTag>
{
    @Override
