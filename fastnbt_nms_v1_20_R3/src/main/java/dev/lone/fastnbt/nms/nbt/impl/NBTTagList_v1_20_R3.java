...
@Implementation.CyclicDependency(type = INBTTagList.class, version = Version.v1_20_R3)
@SuppressWarnings({"unused"})
public class NBTTagList_v1_20_R3 implements INBTTagList<ListTag, Tag, CompoundTag>
{
    @Override
