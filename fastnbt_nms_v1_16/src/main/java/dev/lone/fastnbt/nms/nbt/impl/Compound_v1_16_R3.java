...
@Implementation.CyclicDependency(type = ICompound.class, version = Version.v1_16_R3)
...
public class Compound_v1_16_R3 implements ICompound<NBTTagCompound, NBTTagList, NBTTagCompound>
{
    ...
    {
        if (!handle.hasKeyOfType(key, 11) && handle.hasKeyOfType(key + "Most", 99) && handle.hasKeyOfType(key + "Least", 99))
