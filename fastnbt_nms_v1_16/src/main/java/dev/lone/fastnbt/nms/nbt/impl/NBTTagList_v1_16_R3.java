...
@Implementation.CyclicDependency(type = INBTTagList.class, version = Version.v1_16_R3)
@SuppressWarnings({"unused"})
public class NBTTagList_v1_16_R3 implements INBTTagList<NBTTagList, NBTBase, NBTTagCompound>
{
    @Override
