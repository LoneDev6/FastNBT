...
public class DataComponents_v1_21_7 implements IDataComponents
{
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_7.castToCraftItemStack(bukkitItemStack);
        Component component = CraftItemStack_v1_21_7.getHandle(craftItemStack).get(DataComponents.ITEM_NAME);
        if(component == null)
            return null;
        return CraftChatMessage.toJSON(component);
    }
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_7.castToCraftItemStack(bukkitItemStack);
        ItemEnchantments enchantments = CraftItemStack_v1_21_7.getHandle(craftItemStack).get(DataComponents.ENCHANTMENTS);
    ...
    public void setSkull(ItemStack bukkitItemStack, String name, UUID uuid, String value, String signature)
    {
        ...
        CraftItemStack craftItemStack = CraftItemStack_v1_21_7.castToCraftItemStack(bukkitItemStack);
        CraftItemStack_v1_21_7.getHandle(craftItemStack).set(DataComponents.PROFILE, new ResolvableProfile(profile));
    }
    ...
    public boolean copyAttributeModifiers(ItemStack bukkitItemStackSource, ItemStack bukkitItemStackDestination)
    {
        ...
        CraftItemStack b = CraftItemStack_v1_21_7.castToCraftItemStack(bukkitItemStackDestination);
    ...
    {
        CraftItemStack a = CraftItemStack_v1_21_7.castToCraftItemStack(bukkitItemStackSource);
        ItemLore lore = CraftItemStack_v1_21_7.getHandle(a).get(DataComponents.LORE);
        if(lore == null)
            return false;

        CraftItemStack b = CraftItemStack_v1_21_7.castToCraftItemStack(bukkitItemStackDestination);
        CraftItemStack_v1_21_7.getHandle(b).set(DataComponents.LORE, lore);
        return true;
    }
