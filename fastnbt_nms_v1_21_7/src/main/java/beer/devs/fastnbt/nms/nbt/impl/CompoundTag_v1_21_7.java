...
public class CompoundTag_v1_21_7 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
    ...
    {
        NBTUtilsModern_v1_21_7.putUUID(handle, key, param);
    }
    ...
    {
        return NBTUtilsModern_v1_21_7.getUUID(handle, key);
    }
