...
@Implementation.CyclicDependency(type = ICompound.class, version = Version.v1_17_R1)
@SuppressWarnings({"unchecked", "unused"})
public class Compound_v1_17_R1 implements ICompound<CompoundTag, ListTag, CompoundTag>
{
    @Override
