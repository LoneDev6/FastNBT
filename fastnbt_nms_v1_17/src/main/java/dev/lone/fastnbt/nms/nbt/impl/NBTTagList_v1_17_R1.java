...
@Implementation.CyclicDependency(type = INBTTagList.class, version = Version.v1_17_R1)
@SuppressWarnings({"unused"})
public class NBTTagList_v1_17_R1 implements INBTTagList<ListTag, Tag, CompoundTag>
{
    @Override
