...
@Implementation.CyclicDependency(type = INBTStreamTools.class, version = Version.v1_17_R1)
@SuppressWarnings({"unused"})
public class NBTStreamTools_v1_17_R1 implements INBTStreamTools<CompoundTag>
{
    @Override
