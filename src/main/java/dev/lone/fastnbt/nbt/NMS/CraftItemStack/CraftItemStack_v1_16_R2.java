...
public class CraftItemStack_v1_16_R2 implements ICraftItemStack<NBTTagList, NBTTagCompound, CraftItemStack>
{
    ...
    public boolean hasNbt(ItemStack itemStack)
    {
        ...
        net.minecraft.server.v1_16_R2.ItemStack handle = getHandle(toCraftItemStack(itemStack));
        if(handle == null)
            return false;
    ...
    private net.minecraft.server.v1_16_R2.ItemStack getHandle(org.bukkit.craftbukkit.v1_16_R2.inventory.CraftItemStack craftItemStack)
    {
        try
        {
            return (net.minecraft.server.v1_16_R2.ItemStack) FIELD_HANDLE.get(craftItemStack);
    ...
    @Override
    public net.minecraft.server.v1_16_R2.ItemStack asNMSCopy(ItemStack itemStack)
    {
    ...
    {
        return CraftItemStack.asCraftMirror(net.minecraft.server.v1_16_R2.ItemStack.a(compound));
    }
    ...
    public NBTTagCompound itemStackToCompound(ItemStack itemStack)
    {
        ...
        net.minecraft.server.v1_16_R2.ItemStack nmsCopy = asNMSCopy(itemStack);
