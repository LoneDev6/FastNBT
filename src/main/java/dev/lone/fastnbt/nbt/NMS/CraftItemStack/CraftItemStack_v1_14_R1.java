...
public class CraftItemStack_v1_14_R1 implements ICraftItemStack<NBTTagList, NBTTagCompound, CraftItemStack>
{
    ...
    public boolean hasNbt(ItemStack itemStack)
    {
        ...
        net.minecraft.server.v1_14_R1.ItemStack handle = getHandle(toCraftItemStack(itemStack));
        if(handle == null)
            return false;
    ...
    private net.minecraft.server.v1_14_R1.ItemStack getHandle(CraftItemStack craftItemStack)
    {
        try
        {

            return (net.minecraft.server.v1_14_R1.ItemStack) FIELD_HANDLE.get(craftItemStack);
    ...
    @Override
    public net.minecraft.server.v1_14_R1.ItemStack asNMSCopy(ItemStack itemStack)
    {
    ...
    {
        return CraftItemStack.asCraftMirror(net.minecraft.server.v1_14_R1.ItemStack.a(compound));
    }
    ...
    public NBTTagCompound itemStackToCompound(ItemStack itemStack)
    {
        ...
        net.minecraft.server.v1_14_R1.ItemStack nmsCopy = asNMSCopy(itemStack);
