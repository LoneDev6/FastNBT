...
@Implementation.CyclicDependency(type = INBTStreamTools.class, version = Version.v1_19_R1)
@SuppressWarnings({"unused"})
public class NBTStreamTools_v1_19_R1_2 implements INBTStreamTools<CompoundTag>
{
    @Override
