...
@Implementation.CyclicDependency(type = IListTag.class, version = Version.v1_19_R1)
@SuppressWarnings({"unused"})
public class NBTTagList_v1_19_R1_2 implements IListTag<ListTag, Tag, CompoundTag>
{
    @Override
