...
@Implementation.CyclicDependency(type = INBTTagList.class, version = Version.v1_19_R1)
@SuppressWarnings({"unused"})
public class NBTTagList_v1_19_R1_2 implements INBTTagList<ListTag, Tag, CompoundTag>
{
    @Override
