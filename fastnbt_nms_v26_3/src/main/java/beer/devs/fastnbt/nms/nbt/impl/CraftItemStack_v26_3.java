...
public class CraftItemStack_v26_3 implements ICraftItemStack<ListTag, CompoundTag, CraftItemStack>
{
    public static final Field FIELD_HANDLE;
    private static final Field FIELD_CUSTOM_DATA_TAG;
    private static final MethodHandle AS_CRAFT_COPY;
    private static final MethodHandle AS_CRAFT_MIRROR;
    ...
    static
    {
        ...
        FIELD_CUSTOM_DATA_TAG = CustomDataField.resolve(CustomData.class, CompoundTag.class, CraftItemStack_v26_3.class);
        IS_FIELD_HANDLE_PUBLIC = Modifier.isPublic(FIELD_HANDLE.getModifiers());

        try
        {
            MethodHandles.Lookup lookup = MethodHandles.publicLookup();
            AS_CRAFT_COPY = lookup.findStatic(CraftItemStack.class,
                    NMSImpl.isPaper ? "getCraftStack" : "asCraftCopy",
                    MethodType.methodType(CraftItemStack.class, ItemStack.class));
            AS_CRAFT_MIRROR = lookup.findStatic(CraftItemStack.class,
                            NMSImpl.isPaper ? "asBukkitMirror" : "asCraftMirror",
                            MethodType.methodType(NMSImpl.isPaper ? ItemStack.class : CraftItemStack.class,
                                    net.minecraft.world.item.ItemStack.class))
                    .asType(MethodType.methodType(ItemStack.class, net.minecraft.world.item.ItemStack.class));
        }
    ...
    public CraftItemStack convertToCraft(ItemStack itemStack)
    {
        try
        {
            return (CraftItemStack) AS_CRAFT_COPY.invokeExact(itemStack);
        }
        catch (Throwable e)
        {
            throw new IllegalStateException("Error converting Bukkit ItemStack to CraftItemStack.", e);
        }
    }
    ...
    public void merge(ItemStack itemStack, ItemStack otherItem)
    {
        ...
        simpleMergeComponent(a, b, DataComponents.USE_EFFECTS);
        simpleMergeComponent(a, b, DataComponents.CUSTOM_NAME);
        simpleMergeComponent(a, b, DataComponents.MINIMUM_ATTACK_CHARGE);
        simpleMergeComponent(a, b, DataComponents.DAMAGE_TYPE);
        ...
        simpleMergeComponent(a, b, DataComponents.ATTACK_RANGE);
        simpleMergeComponent(a, b, DataComponents.KINETIC_WEAPON);
        simpleMergeComponent(a, b, DataComponents.PIERCING_WEAPON);
        ...
        simpleMergeComponent(a, b, DataComponents.PROVIDES_POTTERY_PATTERN);
        ...
        simpleMergeComponent(a, b, DataComponents.COOKING_FUEL);
        simpleMergeComponent(a, b, DataComponents.COMPOSTABLE);
        simpleMergeComponent(a, b, DataComponents.BREWING_FUEL);
        simpleMergeComponent(a, b, DataComponents.VILLAGER_FOOD);
        simpleMergeComponent(a, b, DataComponents.VILLAGER_VARIANT);
        simpleMergeComponent(a, b, DataComponents.ZOMBIE_NAUTILUS_VARIANT);
        simpleMergeComponent(a, b, DataComponents.BLOCK_TRANSFORMER);
        simpleMergeComponent(a, b, DataComponents.ADDITIONAL_TRADE_COST);
        simpleMergeComponent(a, b, DataComponents.MOB_VISIBILITY);
        simpleMergeComponent(a, b, DataComponents.SIGN_TEXT_FRONT);
        simpleMergeComponent(a, b, DataComponents.SIGN_TEXT_BACK);
        simpleMergeComponent(a, b, DataComponents.WAXED);
        simpleMergeComponent(a, b, DataComponents.BREAK_SOUND);
        simpleMergeComponent(a, b, DataComponents.ATTACK_ANIMATION);
        simpleMergeComponent(a, b, DataComponents.INTERACT_ANIMATION);
        ...
        simpleMergeComponent(a, b, DataComponents.PIG_SOUND_VARIANT);
        simpleMergeComponent(a, b, DataComponents.COW_VARIANT);
        simpleMergeComponent(a, b, DataComponents.COW_SOUND_VARIANT);
        simpleMergeComponent(a, b, DataComponents.CHICKEN_VARIANT);
        simpleMergeComponent(a, b, DataComponents.CHICKEN_SOUND_VARIANT);
        ...
        simpleMergeComponent(a, b, DataComponents.CAT_SOUND_VARIANT);
        ...
        simpleMergeComponent(a, b, DataComponents.CUSHION_COLOR);
        simpleMergeComponent(a, b, DataComponents.DYE);
        simpleMergeComponent(a, b, DataComponents.SULFUR_CUBE_CONTENT);
    }
    ...
    public void setUUID(ItemStack itemStack, String key, UUID param)
    {
        CraftItemStack craftItemStack = castToCraftItemStack(itemStack);
        net.minecraft.world.item.ItemStack handle = getHandle(craftItemStack);
        updateTag(handle, tag -> NBTUtilsModern_v26_3.putUUID(tag, key, param));
    }
    ...
    public @Nullable UUID getUUID(ItemStack itemStack, String key)
    {
        ...
        return NBTUtilsModern_v26_3.getUUID(readTag(data), key);
    }
    ...
    public ItemStack asCraftMirror(ItemStack itemStack)
    {
        ...
        try
        {
            return (ItemStack) AS_CRAFT_MIRROR.invokeExact(handle);
        }
        catch (Throwable e)
        {
            throw new IllegalStateException("Error creating CraftItemStack mirror.", e);
        }
    }
    ...
    public ItemStack compoundToItemStack(CompoundTag compound)
    {
        ...
        net.minecraft.world.item.ItemStack copy = parsed.orElseThrow().copy();
        try
        {
            return (ItemStack) AS_CRAFT_MIRROR.invokeExact(copy);
        }
        catch (Throwable e)
        {
            throw new IllegalStateException("Error creating Bukkit ItemStack copy.", e);
        }
    }
