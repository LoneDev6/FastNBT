...
public class CompoundTag_v26_3 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
    ...
    {
        NBTUtilsModern_v26_3.putUUID(handle, key, param);
    }
    ...
    {
        return NBTUtilsModern_v26_3.getUUID(handle, key);
    }
