...
@Implementation.CyclicDependency(type = IListTag.class, version = Version.v1_19_R3)
@SuppressWarnings({"unused"})
public class NBTTagList_v1_19_R3 implements IListTag<ListTag, Tag, CompoundTag>
{
    @Override
