...
@Implementation.CyclicDependency(type = ICraftItemStack.class, version = Version.v1_15_R1)
...
public class CraftItemStack_v1_15_R1 implements ICraftItemStack<NBTTagList, NBTTagCompound, CraftItemStack>
{
    ...
    public boolean hasNBT(ItemStack itemStack)
    {
        ...
        net.minecraft.server.v1_15_R1.ItemStack handle = getHandle(castToCraftItemStack(itemStack));
        if (handle == null)
            return false;
    ...
    @Override
    public net.minecraft.server.v1_15_R1.ItemStack asNmsCopy(ItemStack itemStack)
    {
    ...
    public NBTTagCompound itemStackToCompound(ItemStack itemStack)
    {
        ...
        net.minecraft.server.v1_15_R1.ItemStack nmsCopy = asNmsCopy(itemStack);
    ...
    {
        CraftItemStack craftItemStack = castToCraftItemStack(itemStack);
        net.minecraft.server.v1_15_R1.ItemStack handle = getHandle(craftItemStack);
