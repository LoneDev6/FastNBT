...
@Implementation.CyclicDependency(type = INBTTagList.class, version = Version.v1_15_R1)
@SuppressWarnings({"unused"})
public class NBTTagList_v1_15_R1 implements INBTTagList<NBTTagList, NBTBase, NBTTagCompound>
{
    @Override
    ...
    @Override
    public NBTTagCompound getOrAddCompoundAt(NBTTagList list, int i)
    {
