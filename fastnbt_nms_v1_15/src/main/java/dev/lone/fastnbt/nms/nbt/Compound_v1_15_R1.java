...
@Implementation.CyclicDependency(type = ICompoundTag.class, version = Version.v1_15_R1)
@SuppressWarnings({"unchecked", "unused"})
public class Compound_v1_15_R1 implements ICompoundTag<NBTTagCompound, NBTTagList, NBTTagCompound>
{
    @Override
