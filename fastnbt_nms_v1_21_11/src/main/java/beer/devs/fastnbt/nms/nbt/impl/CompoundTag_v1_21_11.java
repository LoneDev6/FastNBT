...
public class CompoundTag_v1_21_11 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
    ...
    {
        NBTUtilsModern_v1_21_11.putUUID(handle, key, param);
    }
    ...
    {
        return NBTUtilsModern_v1_21_11.getUUID(handle, key);
    }
