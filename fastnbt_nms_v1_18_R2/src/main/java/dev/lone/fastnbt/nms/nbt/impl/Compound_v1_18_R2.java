...
@Implementation.CyclicDependency(type = ICompound.class, version = Version.v1_18_R2)
@SuppressWarnings({"unchecked", "unused"})
public class Compound_v1_18_R2 implements ICompound<CompoundTag, ListTag, CompoundTag>
{
    @Override
