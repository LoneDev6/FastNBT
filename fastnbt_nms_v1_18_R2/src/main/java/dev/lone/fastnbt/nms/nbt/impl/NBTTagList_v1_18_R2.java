...
@Implementation.CyclicDependency(type = INBTTagList.class, version = Version.v1_18_R2)
@SuppressWarnings({"unused"})
public class NBTTagList_v1_18_R2 implements INBTTagList<ListTag, Tag, CompoundTag>
{
    @Override
