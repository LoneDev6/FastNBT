...
@Implementation.CyclicDependency(type = ICompoundTag.class, version = Version.v1_17_R1)
@SuppressWarnings({"unchecked", "unused"})
public class CompoundTag_v1_17_R1 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
