...
public class CompoundTag_v1_21_6 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
    ...
    {
        NBTUtilsModern_v1_21_6.putUUID(handle, key, param);
    }
    ...
    {
        return NBTUtilsModern_v1_21_6.getUUID(handle, key);
    }
