...
public class DataComponents_v1_21_6 implements IDataComponents
{
    @Override
    public Object getCustomName(ItemStack bukkitItemStack)
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStack);
        return CraftItemStack_v1_21_6.getHandle(craftItemStack).get(DataComponents.CUSTOM_NAME);
    }
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStack);
        Component component = CraftItemStack_v1_21_6.getHandle(craftItemStack).get(DataComponents.CUSTOM_NAME);
        if(component == null)
            return null;
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStack);
        return CraftItemStack_v1_21_6.getHandle(craftItemStack).get(DataComponents.ITEM_NAME);
    }
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStack);
        Component component = CraftItemStack_v1_21_6.getHandle(craftItemStack).get(DataComponents.ITEM_NAME);
        if(component == null)
            return null;
        return CraftChatMessage.toJSON(component);
    }
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStack);
        ItemEnchantments enchantments = CraftItemStack_v1_21_6.getHandle(craftItemStack).get(DataComponents.ENCHANTMENTS);
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStack);
        ItemLore lore = CraftItemStack_v1_21_6.getHandle(craftItemStack).get(DataComponents.LORE);
        if (lore == null)
            return false;
    ...
    public void setLore(ItemStack bukkitItemStack, List<?> lore)
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStack);
        if(lore == null)
            CraftItemStack_v1_21_6.getHandle(craftItemStack).remove(DataComponents.LORE);
        else
            CraftItemStack_v1_21_6.getHandle(craftItemStack).set(DataComponents.LORE, new ItemLore((List<Component>) lore));
    }
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStack);
        net.minecraft.world.item.ItemStack itemStack = CraftItemStack_v1_21_6.getHandle(craftItemStack);
        if(lore == null)
    ...
    public void setSkull(ItemStack bukkitItemStack, String name, UUID uuid, String value, String signature)
    {
        ...
        CraftItemStack craftItemStack = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStack);
        CraftItemStack_v1_21_6.getHandle(craftItemStack).set(DataComponents.PROFILE, new ResolvableProfile(profile));
    }

    @Override
    public boolean copyAttributeModifiers(ItemStack bukkitItemStackSource, ItemStack bukkitItemStackDestination)
    {
        CraftItemStack a = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStackSource);
        ItemAttributeModifiers modifiersA = CraftItemStack_v1_21_6.getHandle(a).get(DataComponents.ATTRIBUTE_MODIFIERS);
        if(modifiersA == null)
            return false;

        CraftItemStack b = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStackDestination);
        CraftItemStack_v1_21_6.getHandle(b).set(DataComponents.ATTRIBUTE_MODIFIERS, modifiersA);
    ...
    {
        CraftItemStack a = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStackSource);
        ItemLore lore = CraftItemStack_v1_21_6.getHandle(a).get(DataComponents.LORE);
        if(lore == null)
            return false;

        CraftItemStack b = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItemStackDestination);
        CraftItemStack_v1_21_6.getHandle(b).set(DataComponents.LORE, lore);
        return true;
    }
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v1_21_6.castToCraftItemStack(bukkitItem);
        net.minecraft.world.item.ItemStack itemStack = CraftItemStack_v1_21_6.getHandle(craftItemStack);
