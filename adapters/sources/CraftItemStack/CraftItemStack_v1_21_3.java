...
public class CraftItemStack_v1_21_3 implements ICraftItemStack<ListTag, CompoundTag, CraftItemStack>
{
    ...
    static
    {
        ...
        FIELD_CUSTOM_DATA_TAG = CustomDataField.resolve(CustomData.class, CompoundTag.class, CraftItemStack_v1_21_3.class);
    ...
    public void setUUID(ItemStack itemStack, String key, UUID param)
    {
        CraftItemStack craftItemStack = castToCraftItemStack(itemStack);
        net.minecraft.world.item.ItemStack handle = getHandle(craftItemStack);
        updateTag(handle, tag -> tag.putUUID(key, param));
    }
    ...
    public boolean hasUUID(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return false;
        return readTag(data).hasUUID(key);
    }
    ...
    public @Nullable UUID getUUID(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return null;
        return readTag(data).getUUID(key);
    }
    ...
    public byte getByte(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return 0;
        return readTag(data).getByte(key);
    }
    ...
    public short getShort(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return 0;
        return readTag(data).getShort(key);
    }
    ...
    public int getInt(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return 0;
        return readTag(data).getInt(key);
    }
    ...
    public long getLong(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return 0;
        return readTag(data).getLong(key);
    }
    ...
    public float getFloat(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return 0;
        return readTag(data).getFloat(key);
    }
    ...
    public double getDouble(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return 0;
        return readTag(data).getDouble(key);
    }
    ...
    public String getString(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return null;
        return readTag(data).getString(key);
    }
    ...
    public byte[] getByteArray(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return null;
        return readTag(data).getByteArray(key);
    }
    ...
    public int[] getIntArray(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return null;
        return readTag(data).getIntArray(key);
    }
    ...
    public long[] getLongArray(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return null;
        return readTag(data).getLongArray(key);
    }
    ...
    public CompoundTag getCompound(ItemStack itemStack, String key)
    {
        ...
        if (data == null)
            return null;
        return mutableTag(getHandle(craftItemStack)).getCompound(key);
    }
    ...
    public Set<String> getKeys(ItemStack itemStack)
    {
        ...
        CustomData data = getHandle(craftItemStack).get(DataComponents.CUSTOM_DATA);
        if (data != null)
            return readTag(data).getAllKeys();
        return null;
    }
