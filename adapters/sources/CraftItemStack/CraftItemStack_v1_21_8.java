...
public class CraftItemStack_v1_21_8 implements ICraftItemStack<ListTag, CompoundTag, CraftItemStack>
{
    ...
    static
    {
        ...
        FIELD_CUSTOM_DATA_TAG = CustomDataField.resolve(CustomData.class, CompoundTag.class, CraftItemStack_v1_21_8.class);
    ...
    public void setUUID(ItemStack itemStack, String key, UUID param)
    {
        CraftItemStack craftItemStack = castToCraftItemStack(itemStack);
        net.minecraft.world.item.ItemStack handle = getHandle(craftItemStack);
        updateTag(handle, tag -> NBTUtilsModern_v1_21_8.putUUID(tag, key, param));
    }
    ...
    public @Nullable UUID getUUID(ItemStack itemStack, String key)
    {
        ...
        return NBTUtilsModern_v1_21_8.getUUID(readTag(data), key);
    }
