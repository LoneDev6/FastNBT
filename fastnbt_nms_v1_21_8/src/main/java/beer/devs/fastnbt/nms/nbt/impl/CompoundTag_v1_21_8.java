...
public class CompoundTag_v1_21_8 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
    ...
    {
        NBTUtilsModern_v1_21_8.putUUID(handle, key, param);
    }
    ...
    {
        return NBTUtilsModern_v1_21_8.getUUID(handle, key);
    }
