...
import static dev.lone.fastnbt.nms.nbt.CraftItemStack_v1_21_1.castToCraftItemStack;
import static dev.lone.fastnbt.nms.nbt.CraftItemStack_v1_21_1.getHandle;

@Implementation.CyclicDependency(type = IDataComponents.class, version = Version.v1_21_1)
