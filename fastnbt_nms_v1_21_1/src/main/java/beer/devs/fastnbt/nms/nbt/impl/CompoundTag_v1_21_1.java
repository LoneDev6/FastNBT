...
public class CompoundTag_v1_21_1 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
    ...
    public boolean isValid(String component)
    {
        try
        {
            RegistryAccess access = MinecraftServer.getDefaultRegistryAccess();
            new ItemParser(Commands.createValidationContext(access)).parse(new StringReader(component));
            return true;
        }
