...
@Implementation.CyclicDependency(type = ICompoundTag.class, version = Version.v1_21_4)
@SuppressWarnings({"unchecked", "unused"})
public class CompoundTag_v1_21_4 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
