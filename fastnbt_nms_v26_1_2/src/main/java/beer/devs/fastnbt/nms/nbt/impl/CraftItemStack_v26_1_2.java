...
public class CraftItemStack_v26_1_2 implements ICraftItemStack<ListTag, CompoundTag, CraftItemStack>
{
    ...
    static
    {
        ...
        FIELD_CUSTOM_DATA_TAG = CustomDataField.resolve(CustomData.class, CompoundTag.class, CraftItemStack_v26_1_2.class);
    ...
    public void setUUID(ItemStack itemStack, String key, UUID param)
    {
        CraftItemStack craftItemStack = castToCraftItemStack(itemStack);
        net.minecraft.world.item.ItemStack handle = getHandle(craftItemStack);
        updateTag(handle, tag -> NBTUtilsModern_v26_1_2.putUUID(tag, key, param));
    }
    ...
    public @Nullable UUID getUUID(ItemStack itemStack, String key)
    {
        ...
        return NBTUtilsModern_v26_1_2.getUUID(readTag(data), key);
    }
