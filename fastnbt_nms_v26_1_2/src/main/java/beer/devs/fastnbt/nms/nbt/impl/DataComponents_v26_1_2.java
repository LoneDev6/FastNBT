...
public class DataComponents_v26_1_2 implements IDataComponents
{
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v26_1_2.castToCraftItemStack(bukkitItemStack);
        Component component = CraftItemStack_v26_1_2.getHandle(craftItemStack).get(DataComponents.ITEM_NAME);
        if(component == null)
            return null;
        return CraftChatMessage.toJSON(component);
    }
    ...
    {
        CraftItemStack craftItemStack = CraftItemStack_v26_1_2.castToCraftItemStack(bukkitItemStack);
        ItemEnchantments enchantments = CraftItemStack_v26_1_2.getHandle(craftItemStack).get(DataComponents.ENCHANTMENTS);
    ...
    public void setSkull(ItemStack bukkitItemStack, String name, UUID uuid, String value, String signature)
    {
        ...
        CraftItemStack craftItemStack = CraftItemStack_v26_1_2.castToCraftItemStack(bukkitItemStack);
        CraftItemStack_v26_1_2.getHandle(craftItemStack).set(
