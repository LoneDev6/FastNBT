...
public class CompoundTag_v26_1_2 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
    ...
    {
        NBTUtilsModern_v26_1_2.putUUID(handle, key, param);
    }
    ...
    {
        return NBTUtilsModern_v26_1_2.getUUID(handle, key);
    }
