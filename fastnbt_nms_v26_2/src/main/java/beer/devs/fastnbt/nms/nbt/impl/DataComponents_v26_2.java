...
public class DataComponents_v26_2 implements IDataComponents
{
    ...
    public boolean copyAttributeModifiers(ItemStack bukkitItemStackSource, ItemStack bukkitItemStackDestination)
    {
        ...
        CraftItemStack b = CraftItemStack_v26_2.castToCraftItemStack(bukkitItemStackSource);
        ItemAttributeModifiers modifiersB = CraftItemStack_v26_2.getHandle(b).get(DataComponents.ATTRIBUTE_MODIFIERS);
        if(modifiersB != null)
        {
    ...
    public boolean copyLore(ItemStack bukkitItemStackSource, ItemStack bukkitItemStackDestination)
    {
        CraftItemStack a = CraftItemStack_v26_2.castToCraftItemStack(bukkitItemStackSource);
        CraftItemStack b = CraftItemStack_v26_2.castToCraftItemStack(bukkitItemStackSource);
        CraftItemStack_v26_2.getHandle(b).set(DataComponents.LORE, CraftItemStack_v26_2.getHandle(a).get(DataComponents.LORE));
        return true;
    }
