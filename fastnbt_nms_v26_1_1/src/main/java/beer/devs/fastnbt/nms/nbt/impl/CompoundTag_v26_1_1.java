...
public class CompoundTag_v26_1_1 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
    ...
    {
        NBTUtilsModern_v26_1_1.putUUID(handle, key, param);
    }
    ...
    {
        return NBTUtilsModern_v26_1_1.getUUID(handle, key);
    }
