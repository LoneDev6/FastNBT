...
@Implementation.CyclicDependency(type = INBTStreamTools.class, version = Version.v1_19_R2)
@SuppressWarnings({"unused"})
public class NBTStreamTools_v1_19_R2 implements INBTStreamTools<CompoundTag>
{
    @Override
