...
@Implementation.CyclicDependency(type = ICraftItemStack.class, version = Version.v1_19_R2)
@SuppressWarnings({"unchecked", "DataFlowIssue", "CallToPrintStackTrace", "unused"})
public class CraftItemStack_v1_19_R2 implements ICraftItemStack<ListTag, CompoundTag, CraftItemStack>
{
