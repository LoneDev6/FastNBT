...
@Implementation.CyclicDependency(type = IListTag.class, version = Version.v1_19_R2)
@SuppressWarnings({"unused"})
public class NBTTagList_v1_19_R2 implements IListTag<ListTag, Tag, CompoundTag>
{
    @Override
