...
@Implementation.CyclicDependency(type = IListTag.class, version = Version.v1_20_R2)
@SuppressWarnings({"unused"})
public class NBTTagList_v1_20_R2 implements IListTag<ListTag, Tag, CompoundTag>
{
    @Override
