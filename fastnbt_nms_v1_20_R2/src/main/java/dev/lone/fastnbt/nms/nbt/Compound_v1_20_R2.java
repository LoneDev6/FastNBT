...
@Implementation.CyclicDependency(type = ICompoundTag.class, version = Version.v1_20_R2)
@SuppressWarnings({"unchecked", "unused"})
public class Compound_v1_20_R2 implements ICompoundTag<CompoundTag, ListTag, CompoundTag>
{
    @Override
